...
def setup_model(model_name_or_key="deepseek_qwen-14B", use_4bit=True):
    """
...
def train_model(model, tokenizer, processed_datasets):
    ...
    # 保存模型
    model.save_pretrained("./chinese_llm_mcq_model_deepseek_qwen-14B")
    tokenizer.save_pretrained("./chinese_llm_mcq_model_deepseek_qwen-14B")
    print("模型训练完成并保存！")
...
def main():
    # 选择要使用的模型
    selected_model = "deepseek_qwen-14B"  # 可以从CHINESE_MODELS中选择
