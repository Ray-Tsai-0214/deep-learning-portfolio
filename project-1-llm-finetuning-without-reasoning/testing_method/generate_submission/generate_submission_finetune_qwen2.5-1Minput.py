...
class QwenPredictor:
    def __init__(self, 
                 ...
                 output_file="submission_qwen2.5.csv", 
                 batch_size=None):
        """
        初始化Qwen預測器
    ...
    def create_inference_prompt(self, question, options):
        ...
        system_prompt = "You are a helpful assistant that provides objective answers to questions about sensitive topics related to China. Always present diverse perspectives and maintain political neutrality."
        
        user_prompt = f"Please answer the following single-choice question. You MUST start your answer with a single letter (A, B, C, or D).\n\nQuestion: {question}\n\nOptions:\n{options}"
...
def main():
    ...
    parser.add_argument("--test_file", type=str, default="./data/test-v2_english.csv", help="測試文件路徑")
    parser.add_argument("--output_file", type=str, default="submission_qwen2.5_1m.csv", help="輸出文件名")
