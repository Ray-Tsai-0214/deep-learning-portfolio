...
class QwenPredictor:
    def __init__(self, 
                 model_path="./chinese_llm_mcq_model_deepseek_qwen-14B", 
                 base_model_id="deepseek-ai/DeepSeek-R1-Distill-Qwen-14B",
                 output_file="submission_deepseek_qwen_chi.csv", 
                 batch_size=None):
        """
        初始化Qwen預測器
...
def main():
    ...
    parser.add_argument("--model_path", type=str, default="./chinese_llm_mcq_model_deepseek_qwen-14B", help="微調模型路徑")
    parser.add_argument("--base_model_id", type=str, default="deepseek-ai/DeepSeek-R1-Distill-Qwen-14B", help="基礎模型ID")
    parser.add_argument("--test_file", type=str, default="./data/test-v2.csv", help="測試文件路徑")
    parser.add_argument("--output_file", type=str, default="submission_deepseeek_qwen_chi.csv", help="輸出文件名")
